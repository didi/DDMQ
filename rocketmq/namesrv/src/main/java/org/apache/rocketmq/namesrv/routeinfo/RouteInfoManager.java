...
public class RouteInfoManager {
    ...
    private final static long BROKER_CHANNEL_EXPIRED_TIME = 1000 * 60 * 10;
    ...
    public RegisterBrokerResult registerBroker(
        ...
        try {
            try {
                ...
                long startCreateAndUpdateQueueData = System.currentTimeMillis();
                ...
                long stopCreateAndUpdateQueueData = System.currentTimeMillis();
                ...
                log.info("registerBroker,clusterName={},brokerAddr={},lock={},createAndUpdateQueueData={},total={}",
                    clusterName, brokerAddr, getLock - start,
                    stopCreateAndUpdateQueueData - startCreateAndUpdateQueueData, stop - start);
            } finally {
                this.lock.writeLock().unlock();
            }
        } catch (Exception e) {
