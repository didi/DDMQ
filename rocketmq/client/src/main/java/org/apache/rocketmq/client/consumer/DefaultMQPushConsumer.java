...
public class DefaultMQPushConsumer extends ClientConfig implements MQPushConsumer {
    ...
    /**
     * Suspending pulling time for comsuming blocked.
     */
    private long suspendCurrentQueueForBlockTimeMillis = 10;
    ...
    /**
     * shared execute thread pool for consume message
     */
    private ThreadPoolExecutor sharedThreadPoolExecutor = null;
    ...
    public ThreadPoolExecutor getSharedThreadPoolExecutor() {
        return sharedThreadPoolExecutor;
    }

    public void setSharedThreadPoolExecutor(ThreadPoolExecutor sharedThreadPoolExecutor) {
        this.sharedThreadPoolExecutor = sharedThreadPoolExecutor;
    }

    public ScheduledExecutorService getSharedScheduledExecutorService() {
        return sharedScheduledExecutorService;
    }

    public void setSharedScheduledExecutorService(ScheduledExecutorService sharedScheduledExecutorService) {
        this.sharedScheduledExecutorService = sharedScheduledExecutorService;
    }

    public long getSuspendCurrentQueueForBlockTimeMillis() {
        return suspendCurrentQueueForBlockTimeMillis;
    }

    public void setSuspendCurrentQueueForBlockTimeMillis(long suspendCurrentQueueForBlockTimeMillis) {
        this.suspendCurrentQueueForBlockTimeMillis = suspendCurrentQueueForBlockTimeMillis;
    }
