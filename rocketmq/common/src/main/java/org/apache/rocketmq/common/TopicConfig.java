...
public class TopicConfig {
    ...
    public Integer getR() {
        if (readQueueNums == defaultReadQueueNums) return null;
        return readQueueNums;
    }

    public Integer getW() {
        if (writeQueueNums == defaultWriteQueueNums) return null;
        return writeQueueNums;
    }

    public Integer getP() {
        if (perm == (PermName.PERM_READ | PermName.PERM_WRITE)) return null;
        return perm;
    }
    ...
    public TopicFilterType getT() {
        return TopicFilterType.SINGLE_TAG == topicFilterType ? null : topicFilterType;
    }

    public Integer getF() {
        return topicSysFlag == 0 ? null : topicSysFlag;
    }
