...
public class MessageStoreConfig {
    ...
    public int getWaitCountInRoleChange() {
        return waitCountInRoleChange;
    }

    public void setWaitCountInRoleChange(int waitCountInRoleChange) {
        this.waitCountInRoleChange = waitCountInRoleChange;
    }

    public long getWaitIntervalInRoleChange() {
        return waitIntervalInRoleChange;
    }
