...
public class MappedFileQueue {
    ...
    public MappedFile findMappedFileByOffset(final long offset, final boolean returnFirstOnNotFound) {
            ...
            try {
                ...
                if (firstMappedFile != null) {
                    ...
                    if (firstMappedFile != newFirstMappedFile) {
                        LOG_ERROR.warn("firstMappedFiles changed during findMappedFileByOffset. DO RETRY. OLD:{},NEW:{},offset={}.index={},mfSize={},curMFSize={}",
                        ...
                        if (targetMappedFile != null) {
                            ...
                            LOG_ERROR.error("[NOTIFY ME] findMappedFileByOffset failed, offset not match.");
                        } else {
                            return returnFirstOnNotFound ? firstMappedFile : null;
                        }
                    }
                ...
                log.error("findMappedFileByOffset Exception, offset={}", offset, e);
                return null;
            }
        }
        ...
        log.warn("[NOTIFY ME] findMappedFileByOffset failed after 3 retries. Using iteration cost={}, target={}, offset={}",
            System.currentTimeMillis() - start, targetMappedFile, offset);
        if (targetMappedFile != null) {
            return targetMappedFile;
        } else {
